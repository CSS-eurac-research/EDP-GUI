...
urlpatterns = [
    ...
    path('discovery/<str:uuid>', views.result_detail, name='result_detail'),
    path('discovery/linkset/<str:uuid>', views.get_linkset, name='get_linkset'),
    path('discovery/jsonld/<str:uuid>', views.get_jsonld, name='get_jsonld'),
]